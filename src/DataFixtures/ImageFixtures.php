...
class ImageFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $imageList = [
            ...
            4 => ['best-snowboards-for-butter-tricks.jpg', 1, 0],
            5 => ['ollie-snowboard-freestyle-e1452772535411.jpg', 2, 0],
            6 => ['PISTE_Ollie.jpg', 2, 0],
            7 => ['212_1080x.webp', 3, 0],
            8 => ['Snowboard-Grind.jpg', 3, 0],
            9 => ['Cab-180.jpg', 4, 0],
            10 => ['fs360-Web-Ed-Blomfield-featured.jpg', 4, 0],
            11 => ['http __wordpress-604950-1959020.cloudwaysapps.com_wp-content_uploads_2022_04_jon07178-1.avif', 5, 0],
            12 => ['Trick-Indy-Grab-620x447.jpg', 5, 0],
            13 => ['tail-grab-1.jpg', 6, 0],
            14 => ['3_b5916b1c-dec5-4882-8e5d-abf311e254b3_large.jpg', 7, 0],
            15 => ['AdobeStock_486678655-1030x687.jpeg', 8, 0],
            16 => ['images.jpg', 8, 0],
            17 => ['KBS_niseko-cayley-alger_160307_210-Edit.webp', 8, 0],
